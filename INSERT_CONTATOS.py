...
while True:
    ...
    if num == 1:
        # FK = Relacionando Contato com Fornecedor
        while True:
            cnpj = input("\nDigite o CNPJ do fornececedor(apenas números): ")
        ...
        while True:
            ...
            if len(telefoneContato) == 11 and telefoneContato.isdigit():
                ...
                print("O número para contato deve conter exatamente 11 digitos.")       
        ...
        cursor.execute(sql, (nomeContato, nomeContato, telefoneContato, email))
        conector.commit()
